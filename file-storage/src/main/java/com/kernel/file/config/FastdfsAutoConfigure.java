...
import com.kernel.file.properties.FileServerProperties;
import com.kernel.file.service.impl.AbstractIFileService;
 ...
 */
@Configuration
@ConditionalOnProperty(name = "knd.file-server.type", havingValue = "fastdfs")
